# Generated by Powerlevel10k configuration wizard on 2023-03-09 at 17:59 AEDT.
...
() {
  ...
  function prompt_fnm() {
    ...
    [[ $fnm_default == "system" && $fnm_current == "none" ]] && return
    [[ $fnm_default != $fnm_current ]] || return
    p10k segment -b 'magenta' -f 2 -i 'NODE_ICON' -r -t "$fnm_current"
  }
